...
if(isset($_REQUEST['submit'])){
  ...
  if(empty($j_image)){
    ...
    $result = $user->update_journal($id,$j_image,$j_logo,$journal_title,$journal_s_name,$journal_issn_no,$journal_email,$journal_url,$youtube_link,$journal_short_desc,$journal_home_page,$aims_scope_page,$meta_title,$meta_keywords,$meta_desc);
    if($result){
          ...
          <div class="row row-lg">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea id="summernote"  name="meta_desc"  data-plugin="summernote"><?php echo $user->journal_meta_desc; ?></textarea>
                </div>

...
application/x-httpd-php view_editors.php ( HTML document, ASCII text, with CRLF line terminators )
  ...
  <div class="page">
    <div class="page-header">
      ...
      <div class="page-header-actions">
        <a class="btn btn-primary btn-outline  btn-sm" href="add_editors.php?journal_id=<?php echo $journal_id; ?>">
        <i class="icon wb-plus" aria-hidden="true"></i>
        <span class="hidden-sm-down"><b>Add Editors</b></span>
      </a>
      </div>
    </div>
    ...
    <div class="page-content">
      ...
      <div class="panel">
        <header class="panel-heading mb-3">
          <h3 class="panel-title text-center">Editors List</h3>
        </header>
        <div class="panel-body">
         ...
         <?php $user->get_editors($journal_id); ?>
 ...
 <script>
  ...
  <script>
     ...
     stop:function( event ,ui){
       ...
       $.post("editorsdrag.php",{value:parameters,function(editor_data)}){
         alert(editor_data);
       }
     }
      });
